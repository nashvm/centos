...
BUILDER_TYPES ?= vmware virtualbox parallels libvirt
...
BOX_FILES := $(VMWARE_BOX_FILES) $(VIRTUALBOX_BOX_FILES) $(PARALLELS_BOX_FILES) $(LIBVIRT_BOX_FILES)
